...
This library is a work in progress. **MRZ (passport) scanning works on iOS today**; credit card, business card, and receipt modes are on the [roadmap](/guide/getting-started#roadmap). Android is not yet implemented.
:::
